    ...
    marks(String studentid){
      this.studentid=studentid;
        ...
        getContentPane().setBackground(Color.WHITE);
         ...
         JLabel heading=new JLabel("East West Universtiy");
         ...
         lblstudentid.setBounds(60,100,500,20);
         lblstudentid.setFont(new Font("Tahoma",Font.PLAIN,18));
         add(lblstudentid);
         
         JLabel lblsemester=new JLabel("Result of Examination");
         ...
         try{
             Conn c = new Conn();
             ResultSet rs1 = c.s.executeQuery("select * from subject where studentID='"+studentid+"'");
             while(rs1.next()){
                 ...
                 sub5.setText(rs1.getString("subject5"));
                          ...
                          ResultSet rs2 = c.s.executeQuery("select * from marks where studentID='"+studentid+"'");
                                       while(rs2.next()){
        ...
        cancel.setBounds(200,450,120,25);
