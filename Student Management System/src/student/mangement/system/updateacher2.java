...
public class updateteacher2 extends JFrame implements ActionListener{
   ...
   /* JLabel lblsemester =new JLabel("Semester");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            String query="update teacher set name='"+name+"',fname='"+fname+"',uniqueID='"+unique+"',dob='"+dateob+"', address='"+address+"',phone='"+phone+"',teacherID='"+Studentid+"',Qualification='"+qualification+"',department='"+department+"',email='"+Email+"'where teacherID='"+Studentid+"'";
            Conn con = new Conn();
