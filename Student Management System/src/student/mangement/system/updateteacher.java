...
public class updateteacher extends JFrame implements ActionListener{
    ...
    JLabel UniqueID,labelteacherid;
    ...
    labelteacherid = new JLabel();
    labelteacherid.setBounds(200,300,150,30);
    labelteacherid.setFont(new Font("Tahoma",Font.PLAIN,18));
    add(labelteacherid);
   ...
   /* JLabel lblsemester =new JLabel("Semester");
    ...
    labelstudentmail.setBounds(600,350,150,30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String Studentid=labelteacherid.getText();
        String course= tfcourse.getText();
        String department=tfdepartment.getText();
        
        try{
            String query="update teacher set address='"+address+"',phone='"+phone+"',teacherID='"+Studentid+"',Qualification='"+course+"',department='"+department+"'where teacherID='"+Studentid+"'";
            Conn con = new Conn();
